...
export const isWidgetConfigurable: Record<WidgetType, boolean> = {
  ...
  [WidgetType.PowerControl]: false,
  [WidgetType.RobotModel3D]: false,
...
export const widgetDefaultSizes: Partial<Record<WidgetType, SizeRect2D>> = {
  ...
  [WidgetType.PowerControl]: { width: 0.46, height: 0.58 },
  [WidgetType.RobotModel3D]: { width: 0.28, height: 0.34 },
